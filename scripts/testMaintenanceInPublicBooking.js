...
class MaintenancePublicBookingTester {
  constructor() {
  ...
  // Test 2: Admin login (to create maintenance day)
  ...
  // Test 4: Check maintenance days for date range (public API)
  async testCheckMaintenanceRange() {
    console.log('\n📅 Testing Check Maintenance Range (Public)...');
    ...
    try {
      ...
      const result = await this.makeRequest('GET', `/maintenance/check/range?startDate=${startDate.toISOString()}&endDate=${endDate.toISOString()}`);
  ...
  async testBookingDuringMaintenance() {
    console.log('\n🚫 Testing Booking During Maintenance (Public)...');
  ...
  async testAvailabilityDuringMaintenance() {
    console.log('\n🔍 Testing Availability During Maintenance (Public)...');
  ...
  async testBookingOnDifferentDates() {
    console.log('\n✅ Testing Booking On Different Dates (Public)...');
  ...
  // Run all tests
  async runAllTests() {
    console.log('🔧 Testing Maintenance Day in Public Booking');
    ...
    try {
      ...
      if (this.results.failed === 0) {
        console.log('\n🎉 All maintenance public booking tests passed!');
        console.log('✅ Maintenance day system works in public booking');
        console.log('✅ Bookings are properly blocked during maintenance');
        console.log('✅ Availability checks work correctly');
        console.log('✅ Public booking respects maintenance days');
      } else {
...
async function main() {
  try {
    const tester = new MaintenancePublicBookingTester();
...
module.exports = MaintenancePublicBookingTester; 